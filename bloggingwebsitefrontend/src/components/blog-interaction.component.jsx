...
const BlogInteraction = () => {
    ...
    let { blog, blog: { _id, blog_id, activity, activity: {total_likes, total_comments}, author: { personal_info: {username: author_username}} }, setBlog, islikeByUser, setLikedByUser, setCommentsWrapper } = useContext(BlogContext);
    ...
    const handleLike = () => {
        if(access_token) {
           ...
           // not logged in
            toast.error("please login to liked")
        }
    }
    ...
    <>
        ...
        <div className='flex gap-6 justify-between'>
            ...
            <div className='flex gap-6 items-center'>
                ...
                <Link><i className='fi fi-brands-twitter text-xl hover:text-twitter'></i></Link>
            </div>
        </div>
