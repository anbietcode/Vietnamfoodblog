    ...
    <>
      <nav className="navbar">
        <Link to="/" className="flex-none w-50">
          <img src={logo} className="w-full h-full" style={{height: 50 + "px", width: 200 + 'px'}} />
        </Link>
       <div
          className={
      ...
      <input
          ...
          <i
            class="fi fi-br-search absolute right-[10%]
        ...
        flex items-center justify-center"
...

          {
            ...
            <div className="relavtive" onClick={handleUserNavPanel}>
